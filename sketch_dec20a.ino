...
goForwards_for_dispacement_with_turn(100, 84);

goForwards_for_dispacement_with_turn(60, 70);

goBackwards_for_dispacement_with_turn(-60, 110);
...
//    if(inputs[i]=='2')
//    {
//      goForwards_for_dispacement_with_turn(10, 84); // go stright for 10 cm     
//    }
